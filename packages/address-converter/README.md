...
``` ts
import {ethToEthermint, ethermintToEth} from "address-converter"
...
``` ts
import {ETH, ETHERMINT} from "address-converter"
...
```ts
import {ethToEvmos, evmosToEth} from "address-converter"
